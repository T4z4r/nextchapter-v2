    ...
    <div class="tp-split">
      <div class="tp-fields">
        ...
        <div class="field">
          ...
          @endif
          <x-dropzone name="image" label="Drop thumbnail image here" accept="image/png,image/jpeg,image/webp,image/gif" hint="JPG, PNG, WebP or GIF — max 5 MB"/>
        ...
        <div class="field">
          ...
          @endif
          <x-dropzone name="video" label="Drop video file here" accept="video/mp4,video/webm,video/ogg,video/quicktime" hint="MP4, WebM, OGG or MOV — max 20 MB"/>
