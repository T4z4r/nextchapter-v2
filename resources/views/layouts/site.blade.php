...
<link rel="icon" type="image/png" href="{{ asset($settings->logo_path ?: 'images/nextchapter-logo.png') }}">
  ...
  <div class="wrap nav">
    <a href="{{ route('home') }}#top" class="brand" aria-label="{{ $settings->site_name }} home">
      @if($settings->logo_path)
        <img class="brand-logo" src="{{ asset($settings->logo_path) }}" alt="{{ $settings->site_name }}">
      @else
